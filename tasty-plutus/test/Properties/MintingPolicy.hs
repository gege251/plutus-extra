...
userPKHash1 = unPaymentPubKeyHash $ mockWalletPaymentPubKeyHash $ fromWalletNumber $ WalletNumber 1

userPKHash2 :: PubKeyHash
userPKHash2 = unPaymentPubKeyHash $ mockWalletPaymentPubKeyHash $ fromWalletNumber $ WalletNumber 2
